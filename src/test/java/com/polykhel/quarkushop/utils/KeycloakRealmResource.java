package com.polykhel.quarkushop.utils;
...
public class KeycloakRealmResource implements QuarkusTestResourceLifecycleManager {
    ...
    public static DockerComposeContainer KEYCLOAK = new DockerComposeContainer(
            ...
            .withExposedService("keycloak_1", 9080, Wait.forListeningPort().withStartupTimeout(Duration.ofSeconds(30)));
    ...
    public Map<String, String> start() {
        ...
        try {
            String adminAccessToken = tokenService.getAccessToken(jwtIssuerUrl, "admin", "test", "quarkus-client", "mysecret");
