...
import com.polykhel.domain.OrderItem;
import com.polykhel.dto.OrderItemDto;
import com.polykhel.repository.OrderItemRepository;
import com.polykhel.repository.OrderRepository;
import com.polykhel.repository.ProductRepository;
...
public class OrderItemService {
    ...
    public void delete(Long id) {
        ...
        order.setPrice(order.getPrice().subtract(orderItem.getProduct().
                getPrice()));
